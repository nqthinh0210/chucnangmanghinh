...
<!DOCTYPE html>
<head>
<title>Login | Login :: w3layouts</title>
...
<!-- //font-awesome icons -->
<script src="{{URL::asset('public/js/jquery2.0.3.min.js')}}"></script>
</head>
<body>
    <?php
        ...
        <div class="w3layouts-main">
            <h2>Sign In Now</h2>
                <form action="{{URL::to('/login-user')}}" method="post">
                    ...
                    <input type="text" class="ggg" name="email_user" placeholder="E-MAIL" required="">
                    <input type="password" class="ggg" name="password_user" placeholder="PASSWORD" required="">
...
<script src="{{URL::asset('public/js/jquery.dcjqaccordion.2.7.js')}}"></script>
<script src="{{URL::asset('public/js/scripts.js')}}"></script>
<script src="{{URL::asset('public/js/jquery.slimscroll.js')}}"></script>
